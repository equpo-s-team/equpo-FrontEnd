...
export default function CTAFinal() {
    return (
        ...
        >
            ...
            <div className="absolute bottom-[10%] right-[8%] w-[120px] h-[120px] rounded-full border pointer-events-none"
            ...
            <div className="relative z-10 max-w-[820px] mx-auto text-center">
                ...
                <ul className="list-none flex justify-center flex-wrap gap-6">
                    {[
                        ...
                        { label: 'Diseñado para mejorar hábitos colectivos', grad: 'linear-gradient(135deg,#d99aee,#5961F9)' },
                    ].map((item) => (
