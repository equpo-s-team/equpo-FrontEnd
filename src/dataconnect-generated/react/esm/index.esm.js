import { createUserRef, backfillUserEmailRef, touchUserLastActiveRef, updateUserProfileRef, getUserRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useBackfillUserEmail(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
