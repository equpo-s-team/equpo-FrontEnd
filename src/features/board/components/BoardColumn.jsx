...
function ColIndicator({accent}) {
    ...
    return (
        <div
            className={`w-2 h-2 rounded-full ${cfg.indicator} ${cfg.indicatorAnim}`}
        />
    );
}

function DropZone({onDrop, columnIndex, position}) {
    const handleDrop = (e) => {
        e.preventDefault();
    ...
    return (
      ...
      `}
        >
            ...
            >
                <div className={`w-full h-full ${cfg.topBar} opacity-60`}
            ...
            <div className="flex items-center justify-between px-4 pt-5 pb-3">
                <div className="flex items-center gap-2.5">
                    ...
                    <span className={`font-maxwell text-[12px] font-bold tracking-[0.6px] uppercase ${cfg.title}`}>
            {label}
          </span>
