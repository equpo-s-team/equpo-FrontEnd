...
export default function NeonLoadingOverlay({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-50 flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800">
      <div className="relative h-24 w-24 animate-spin rounded-full bg-gray-100 shadow-neonBlue [animation-duration:1.2s]">
        ...
        <div className="absolute inset-[10px] rounded-full border-[5px] border-gray-100 bg-gray-100 dark:border-gray-800 dark:bg-gray-800" />
      </div>
