  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 flex items-center gap-2.5 z-20 pointer-events-auto">
      ...
      >
        ...
        />
        <span className="text-xs font-bold uppercase tracking-[0.5px] text-grey-700">En vivo</span>
        <div className="w-px h-4 bg-grey-300/80" />
        <span className="font-maxwell text-sm font-bold text-grey-800 tabular-nums">
