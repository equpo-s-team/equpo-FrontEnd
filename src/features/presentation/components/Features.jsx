    ...
    return (
        <section id="features" className="relative py-24 px-[5vw] overflow-hidden bg-white">
            ...
            <div className="absolute inset-0 pointer-events-none"
                 style={{
                     backgroundImage: 'radial-gradient(circle at 20% 50%, rgba(156,237,193,0.07) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(96,175,255,0.07) 0%, transparent 50%), radial-gradient(circle at 60% 80%, rgba(246,90,112,0.05) 0%, transparent 50%)',
                 }} />
...
function FeatureCard({ feat, delay }) {
    ...
    return (
        ...
        >
            ...
            <span className="font-body text-[.78rem] font-semibold flex items-center gap-1"
