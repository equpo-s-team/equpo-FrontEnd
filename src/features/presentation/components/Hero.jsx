    ...
    return (
        <section className="relative overflow-hidden min-h-screen bg-white">
            ...
            <div className="absolute -top-32 -left-32 w-[520px] h-[520px] rounded-full pointer-events-none"
                 style={{ background: 'radial-gradient(circle, rgba(156,237,193,0.22) 0%, transparent 70%)' }} />
            ...
            <div className="max-w-full mx-auto px-16 grid md:grid-cols-2 gap-0 items-center pt-8 pb-0 min-h-[90vh] relative z-10">
                ...
                <div className="hero-copy-enter py-16 pr-8">
                    <div className="flex items-center gap-3 mb-8">
                        <span className="block w-8 h-1 rounded"
                              style={{ background: 'linear-gradient(90deg, #9CEDC1, #60AFFF)' }} />
                        <span className="font-body text-[0.85rem] font-bold tracking-[0.2em] uppercase"
                              style={{ background: 'linear-gradient(90deg, #38b97a, #2e8fd4)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    ...
                    <div className="flex flex-col gap-2.5 mb-8">
                        {[
                            ...
                            <p key={txt} className="font-body text-[0.9rem] text-grey-500 flex items-center gap-2">
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                        {[
                            { label: 'Tablero colaborativo', grad: 'from-green-50 to-cyan-50', border: 'border-green-200', text: 'text-green-700' },
                            { label: 'Chat + llamadas', grad: 'from-blue-50 to-cyan-50', border: 'border-blue-200', text: 'text-blue-700' },
                            { label: 'Puntos y niveles', grad: 'from-purple-50 to-pink-50', border: 'border-purple-200', text: 'text-purple-700' },
                            { label: 'Responsabilidad colectiva', grad: 'from-orange-50 to-red-50', border: 'border-red-200', text: 'text-red-600' },
                        ].map((badge) => (
                            <span
                                key={badge.label}
                ...
                <div className="hero-visual-enter relative h-full min-h-screen -mr-[5vw] overflow-visible" style={{ marginRight: 'calc(-5vw)'}}>
...
function FloatCard({ className = '', icon, title, label, iconBg, accentColor }) {
    return (
        <motion.div
