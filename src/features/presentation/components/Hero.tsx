    ...
    <>
      <section className="relative overflow-hidden min-h-auto md:min-h-screen bg-white dark:bg-gray-900">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(246,90,112,0.10) 0%, transparent 70%)',
          }}
        />
...
function FloatCardRing({ title, label }: FloatCardRingProps) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
    >
      <div className="w-9 h-9 bg-gradient-purple-bg rounded-xl flex items-center justify-center flex-shrink-0">
