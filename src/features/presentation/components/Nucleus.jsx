...
import { Heart, Rocket, Zap, Globe, TrendingUp } from 'lucide-react';
...
export default function Nucleus() {
    ...
    return (
        <section id="nucleus" className="relative py-24 px-[5vw] overflow-hidden"
            ...
            <div className="absolute bottom-[-60px] left-[-60px] w-[360px] h-[360px] rounded-full pointer-events-none"
