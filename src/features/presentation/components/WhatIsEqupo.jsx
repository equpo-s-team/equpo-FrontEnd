        ...
        <section id="what" className="relative py-24 px-[5vw] overflow-hidden" style={{background: '#ffffff'}}>
            ...
            <div className="max-w-[1160px] mx-auto grid md:grid-cols-2 gap-20 items-center relative z-10">
                ...
                <div className="relative">
                    ...
                    {/* World widget */}
                    <div
                        className="absolute -bottom-6 -right-6 bg-white border border-grey-150 rounded-2xl px-5 py-4 shadow-card-lg flex items-center gap-3 min-w-[190px]">
                        ...
                        <div className="font-body text-[.75rem]">
                            <strong className="block font-semibold text-grey-800 text-[.82rem]">Mundo
                                prosperando</strong>
