...
export function KpiCard({ variant, label, value, sub }: KpiCardProps) {
  ...
  return (
    <div
      className="relative bg-white dark:bg-gray-800 border rounded-[14px] px-5 pt-5 pb-4 overflow-hidden transition-all duration-200 hover:-translate-y-0.5"
    ...
    >
      ...
      <div className="relative z-10">
        <p className="text-xs font-medium text-grey-500 dark:text-grey-400 mb-2.5">{label}</p>
        <p className="text-4xl font-semibold tracking-[-0.04em] text-grey-900 dark:text-gray-100 leading-none">
          {value}
        </p>
