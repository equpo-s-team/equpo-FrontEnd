...
export function MemberList({ members }: MemberListProps) {
  ...
  return (
    <div
      className="relative flex h-full min-h-0 flex-col bg-white dark:bg-gray-800 border border-grey-150 dark:border-gray-700 rounded-[14px] p-6 overflow-hidden da"
