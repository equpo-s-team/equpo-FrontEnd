...
export function StatusDonut({ data }: StatusDonutProps) {
  ...
  return (
    <div
      className="relative flex-shrink-0 bg-white dark:bg-gray-800 border border-grey-150 dark:border-gray-700 rounded-xl p-3 sm:p-4 lg:p-6 overflow-hidden"
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-5 relative z-10">
        ...
        <div className="w-full grid grid-cols-2 gap-1.5 sm:gap-2">
          {STATUS_ITEMS.map((item) => (
            <div
              key={item.key}
              className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 sm:py-2.5 bg-grey-50 dark:bg-gray-700 border border-grey-100 dark:border-gray-600  rounded-lg sm:rounded-xl text-xs sm:text-sm"
            >
              <div
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs sm:text-sm font-semibold text-grey-800 dark:text-gray-300">
          ...
          {/* Overdue - full width */}
          <div className="col-span-2 flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 sm:py-2.5 bg-[rgba(246,90,112,0.04)] dark:bg-red/10 dark:border-red/30 border border-[rgba(246,90,112,0.2)] rounded-lg sm:rounded-xl">
            <div
              className="w-[6px] h-[6px] sm:w-[7px] sm:h-[7px] rounded-full flex-shrink-0"
