      ...
      >
        <div className="rounded-2xl bg-white/96 backdrop-blur-xl overflow-hidden">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #60AFFF 0%, #9b7fe1 50%, #9CEDC1 100%)', opacity: 0.7 }}
          />
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex items-end justify-between -mt-8 mb-4">
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #60AFFF, #5961F9)', boxShadow: '0 4px 20px rgba(96,175,255,0.4)' }}
              >
                {user.avatarInitials}
              </div>
              <button onClick={onClose} className="w-7 h-7 rounded-full bg-grey-100 hover:bg-grey-200 flex items-center justify-center text-grey-400 text-xs transition-colors">
                ✕
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              {[
                ...
                <div key={stat.label} className="bg-grey-50 rounded-xl p-3 text-center border border-grey-100">
                  <p
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #60AFFF, #9b7fe1)', boxShadow: '0 6px 20px rgba(96,175,255,0.35)' }}
            >
              Ver perfil completo
            </button>
          </div>
