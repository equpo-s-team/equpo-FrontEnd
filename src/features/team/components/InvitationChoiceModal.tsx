    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 animate-fade-in">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl border border-grey-100 transform transition-all duration-300 scale-100 animate-slide-up">
        ...
        <div className="flex flex-col items-center p-8 pb-6 border-b border-grey-100">
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 w-8 h-8 rounded-lg flex items-center justify-center text-grey-400 hover:text-grey-600 hover:bg-grey-100 transition-colors"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <div className="p-8 pt-6 space-y-4">
          ...
          <button
            ...
            className="w-full p-5 rounded-xl border-2 border-grey-200 hover:border-blue hover:bg-blue/5 transition-all duration-200 text-left group transform hover:scale-[1.02] active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="w-full p-5 rounded-xl border-2 border-grey-200 hover:border-purple hover:bg-purple/5 transition-all duration-200 text-left group transform hover:scale-[1.02] active:scale-[0.98]"
          >
            <div className="flex items-center gap-4">
